...
interface IERC3475 {
    ...
    /** TODO: combine this ith the settlementTransactionRepository by id.
     * @dev structure allows the transfer of any given number of bonds from one address to another.
    ...
    struct Transaction {
        ...
        uint256 nonceId;
        uint256 amount;
        // TODO: SettlementTransactionRepository parameters
        uint256 txnId;
        uint256 operationId;
        ...
        string txHash;
        // token parameters  
        uint256 initialSupply; // initial == currentSupply == amount
